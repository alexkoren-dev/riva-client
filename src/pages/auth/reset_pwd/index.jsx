...
const ResetPwd = props => {
	...
	const onFinish = async values => {
		setLoading(true)
		try {
			await dispatch(AuthActions.changePassword({ password: values.password }, token))
			setLoading(false)
					...
					<Col md={14} span={24}>
						<div className="auth-view__form">
							...
							>
								...
								>
									<Input.Password placeholder="Password" className="form-control" size="large"/>
								</Form.Item>
								<Form.Item
									name="confirm"
								...
								>
									<Input.Password placeholder="Confirm Password" className="form-control" size="large"/>
								</Form.Item>
